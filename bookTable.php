             ...
             echo "<td><a href='detailsTable.php?id=".$query1['id']."&tname=".$query1["tname"]."'>Book Table</a></td>";
             echo "</tr>";
               } 
               }
else 
...
<div class="container">
    <div class="jumbotron">
        ...
        <h4 style="text-align: right; "><b><?php echo $name ?></b></h4>
        <h5 style="position: absolute;right:10%;top:188px; font-size: 19px;"> <a href="logout.php">Logout</a></h5>
    </div>
    <div class="row">
        <div class="col-lg-1">
        </div>
